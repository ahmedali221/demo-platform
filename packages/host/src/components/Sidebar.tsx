...
export default function Sidebar({
  ...
  const navItems: NavItemDef[] = [
    ...
    { id: "couriers",  labelKey: "sidebar.couriers",  icon: Truck },
    {
      id: "data-import",
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: "settings-platforms",     labelKey: "sidebar.settingsPlatforms",     icon: LayoutGrid },
    ...
    >
      ...
      <div className="flex w-full  px-4 ">
        <button
          ...
          className="ml-auto text-gray-500 hover:text-gray-900 transition-colors p-2 rounded-xl hover:bg-gray-100 group relative"
        >
          {collapsed && (
            <div
              className={[
                    ...
                    {item.subItems.map((sub) => {
                      ...
                      return (
                        ...
                        >
                          <SubIcon
                            size={15}
                            className={isSubActive ? "text-[#2E75B6]" : "text-gray-500"}
                          />
                          {t(sub.labelKey)}
                        </button>
                      );
      ...
      <div className="px-3 pb-5 pt-2 border-t border-gray-100">
        <button
          onClick={onLogout}
          className={[
            "flex items-center gap-3.5 px-4 py-3 rounded-xl transition-all duration-200 text-sm font-semibold w-full text-red-500 hover:bg-red-50 hover:text-red-700 group relative",
            collapsed ? "justify-center" : "",
          ].join(" ")}
        >
          {collapsed && (
